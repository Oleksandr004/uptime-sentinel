...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$alert$2d$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/alert-dialog.tsx [app-client] (ecmascript)"); // Убедись, что путь верный
;
...
const MonitorCard = ({ id, name, url, status: initialStatus, latency: initialLatency, history: initialHistory })=>{
    ...
    const handleDelete = async ()=>{
        try {
            const response = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5000") || 'http://localhost:5000'}/monitors/${id}`, {
                method: 'DELETE'
            });
...
// 'use client'
// import { MonitorCard } from '@/src/entities/monitor/ui/monitor-card'
...
// 	},
// }
// // Конфигурация для каждой карточки
// const itemVariants = {
...
// }
// export const MonitorList = ({ monitors }: { monitors: any[] }) => {
...
// 	return (
// 		<motion.div
// 			layout // Магия плавного перемещения сетки
...
// 	monitors: any[] // Принимаем массив мониторов из API
// }
// export const StatsOverview = ({ monitors }: StatsOverviewProps) => {
// 	// --- ЛОГИКА РАСЧЕТА ---
// 	// 1. Считаем средний Uptime (SLA)
// 	// Мы берем среднее значение uptimePercentage всех мониторов
// 	const avgUptime =
// 		monitors.length > 0
// 			? (
...
// 			  ).toFixed(2)
// 			: '0.00'
// 	// 2. Считаем среднюю задержку (Latency)
// 	const avgLatency =
// 		monitors.length > 0
// 			? Math.round(
...
// 			  )
// 			: 0
// 	// 3. Считаем общее кол-во инцидентов (падений) за все время
...
// 				<div
// 					key={stat.label}
// 					className='bg-white p-6 rounded-xl border border-slate-200 shadow-sm transition-hover hover:border-slate-300'
// 				>
...
// 						</div>
// 						<div
// 							className={`p-3 rounded-xl bg-slate-50 ${stat.color} shadow-inner`}
// 						>
// 							<stat.icon size={24} />
// 						</div>
// 					</div>
// 					<div className='mt-4 flex items-center text-[11px] font-bold text-slate-400 uppercase'>
...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            fetch(`${("TURBOPACK compile-time value", "http://localhost:5000") || 'http://localhost:5000'}/monitors`).then({
            ...
            children: [
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                    className: "text-3xl font-black text-slate-900 tracking-tight italic",
                                    children: "SENTINEL"
                                }, void 0, false, {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$shared$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                className: "bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-6 py-6 shadow-lg shadow-blue-100 flex gap-2 transition-all active:scale-95",
                                children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                    ...
                                    className: "w-full pl-12 pr-10 py-3.5 bg-white border border-slate-200 rounded-2xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all text-slate-700 font-medium"
                                }, void 0, false, {
                                    fileName: "[project]/app/page.tsx",
                                    lineNumber: 78,
                                    columnNumber: 7
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex bg-slate-200/50 p-1.5 rounded-2xl gap-1 w-full md:w-auto",
                            children: [
                                'ALL',
                                'UP',
                                'DOWN'
                                    ...
                                    className: `flex-1 md:flex-none px-6 py-2 rounded-xl text-sm font-bold transition-all ${filterStatus === status ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-700'}`,
                                    children: [
                                        status === 'ALL' && 'Все',
                                        status === 'UP' && 'Online',
                                        status === 'DOWN' && 'Offline'
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "p-4 bg-slate-50 rounded-full mb-4",
...
_s(DashboardPage, "cG9/RYdv57zabr/k2uVSwfc1iEU=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_4b490c0c._.js.map