...
const MonitorList = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MonitorList.useEffect": ()=>{
            const fetchMonitors = {
                "MonitorList.useEffect.fetchMonitors": async ()=>{
                    try {
                        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5000")}/monitors`);
                        ...
                        console.error(err);
                        setError(err.message || 'Ошибка при загрузке мониторов');
                    } finally{
                        setLoading(false);
                    }
                }
            }["MonitorList.useEffect.fetchMonitors"];
            fetchMonitors();
        }
    }["MonitorList.useEffect"], []);
...
_s(MonitorList, "ZxENgxrzN///DtvIfaRlg2Dd0dc=");
_c = MonitorList;
var _c;
...
//# sourceMappingURL=_b16e4899._.js.map